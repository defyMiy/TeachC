...
// 5. int ประการตัวแปรเป็นชนิดตัวเลข (integer)
// 6. if(เปรียบเทียบ) {จริงแล้วทำอะไร...} else {ไม่จริงแล้วทำอะไร...}
// 7. for(เซ็ทค่าเริ่มต้น; เซ็นค่าสุดท้าย; เซ็ทตัวนับ) {วนลูปทำอะไร...}
// 8. debug หมายถึง การขจัดปัญหาและจุดบกพร่องต่าง ๆ ในโปรแกรมให้หมดไป ก่อนที่จะนำโปรแกรมนั้นไปใช้ ที่ใช้ศัพท์คำนี้เพราะนักเขียนโปรแกรมจะเรียก จุดบกพร่องของโปรแกรมว่า bug ดู bug ประกอบ
// วิธีการ debug ที่ได้ผลเป็นอย่างดีคือการเข้าไปดูค่าข้างในกลไกนั้นๆ ว่าเกิดอะไรขึ้นบ้าง debug อีกนัยหนึ่งหมายถึงการตรวจดูโปรแกรมเชิงลึก
